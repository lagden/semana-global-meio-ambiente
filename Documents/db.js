var db = {
    introducao: {
        pt: '\
<p>Dia 5 de junho é o Dia Internacional do Meio Ambiente e nós queremos aproveitar esta data para reafirmar nosso compromisso com a proteção ao meio ambiente, fundamental na estratégia de nossos negócios.</p>\
<p>Investimos em ações que contribuem para o uso sustentável dos recursos naturais e estamos comprometidos com a manutenção dos ecossistemas e com a conservação das espécies ameaçadas de extinção.</p>\
<p>Durante esta semana, queremos discutir e vivenciar o tema da sustentabilidade e meio ambiente com nossos empregados e despertar a consciência ambiental em todos.</p>\
<p>Confira abaixo algumas ações da nossa empresa:</p>',
        en: '\
<p>June 5 is International Environment Day and we would like to take this opportunity to reaffirm our commitment to protecting the environment, something that is fundamental to our business strategy.</p>\
    ...
    exemplo: {
        ...
        accordion: [{
            ...
            body: {
                pt: '\
<ul>\
<li>Participar das campanhas de conservação e melhoria do meio ambienite referentes ao consumo de água, energia, coleta seletiva, entre outras, da sua Unidade</li>\
...
<li>Deje abierto el grifo apenas cuando vaya a usar el agua; evite ensuciar baños, comedores y otras dependencias de la empresa;</li>\
            ...
            body: {
                pt: '\
<ul>\
<li>Dar preferência ao transporte coletivo ao invés de transporte individual;</li>\
<li>Sempre que possível, faça trajetos menores à pé;</li>\
...
<li>Prefiera adquirir vehículos más económicos o híbridos, siempre que sea posible.</li>\
            ...
            body: {
                pt: '\
<ul>\
<li>Evitar comprar produtos supérfluos e de baixa durabilidade;</li>\
<li>Ler os rótulos para a escolha de produtos no supermercado;</li>\
...
<li>Separe papeles, plásticos, vidrios y metales para la recolección selectiva; done el material recogido para instituciones filantrópicas o destínelo para recicladores.</li>\
            ...
            body: {
                pt: '\
<ul>\
<li>Na compra de aparelhos elétricos, preferir equipamentos com o selo PROCEL de Economia de Energia;</li>\
<li>Evitar equipamentos ligados sem necessidade;</li>\
<li>Desligar as luzes e equipamentos elétricos, incluindo aparelhos de ar condicionado, sempre que não forem necessários durante o dia;</li>\
<li>Quando possível, colocar o computador em espera, desligar a máquina quando for se ausentar por muito tempo, não se esquecer de desligar também os periféricos do computador: estabilizadores, filtros de linha, scanner e impressoras; evitar utilizar o elevador para subir um ou descer dois andares;</li>\
<li>Preferir lâmpadas fluorescentes porque são mais econômicas;</li>\
